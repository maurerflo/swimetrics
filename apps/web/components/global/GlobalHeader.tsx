...
const renderMenuItem = (item: GlobalHeaderMenuItem) => {
    if (item.items) {
        return (
...
const renderMobileMenuItem = (item: GlobalHeaderMenuItem) => {
    if (item.items) {
        return (
...
const SubMenuLink = ({item}: { item: GlobalHeaderMenuItem }) => {
    return (
        <a
